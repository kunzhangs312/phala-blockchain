...
#[post("/reset_system_state", format = "json", data = "<contract_input>")]
fn reset_system_state(contract_input: Json<ContractInput>) -> JsonValue {
    println!("{}", ::serde_json::to_string_pretty(&*contract_input).unwrap());
...
fn rocket() -> rocket::Rocket {
    let mut server = rocket::ignite()
        .mount("/", routes![
            ...
            set, get, get_runtime_info, reset_system_state]);
